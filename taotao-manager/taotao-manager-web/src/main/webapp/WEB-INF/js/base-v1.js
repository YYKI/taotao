 ...
 */
function login() {
    return location.href = "http://192.168.139.128:8084/user/showLogin";
}
function regist() {
    return location.href = "http://192.168.139.128:8084/user/showRegister";
}
...
function search(a) {
    var b = "http://192.168.139.128:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
